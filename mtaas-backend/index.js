...
var TestRunner=require('./api/testRunner')
...
var appFileStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, './applicationFile/')
  },
  filename:function(req,file,cb){
    let replacedCharacter=req.body.username
    replacedCharacter=replacedCharacter.replace(/[\W_]+/g,"_");
    req.body.appFileName=replacedCharacter+'_'+file.originalname
    cb(null,req.body.appFileName)
  }
})
var upload = multer({ storage: appFileStorage });

app.post('/runner/createRun',upload.single('file'),(req,res)=>{
  console.log('Application file stored in the applicationFileFolder')
  TestRunner.createRun(req,res)
})

app.post('/runner/oneProjectAllRunsTester',(req,res)=>{
  TestRunner.getOneProjectAllRunsTester(req,res)
})

app.post('/runner/getRunUpdate',(req,res)=>{
  TestRunner.getRunStatus(req,res)
})

app.post('/runner/stopRun',(req,res)=>{
  TestRunner.stopRun(req,res)
})

app.post('/runner/getSingleRun',(req,res)=>{
  TestRunner.getSingleRun(req,res)
})

app.post('/runner/getSuitesOfDeviceOfRun',(req,res)=>{
  TestRunner.getDeviceOfARun(req,res)
})

app.post('/runner/getTestsOfSuitesOfDeviceOfRun',(req,res)=>{
  TestRunner.getTestsOfDeviceOfRun(req,res)
})

app.post('/runner/getArtifactsOfTestOfSuitesOfDeviceOfRun',(req,res)=>{
  TestRunner.getArtifactsOfTestOfSuiteOfDeviceOfRun(req,res)
})
