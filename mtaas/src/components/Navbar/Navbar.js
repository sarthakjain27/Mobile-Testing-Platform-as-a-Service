...
class Navbar extends React.Component {
    navHandler = e => {
        ...
        else if(e==='schedule_run')
        {
            redirectNav = <Redirect to='/scheduleRun' />
        }
        else if(e==='run_list')
        {
            redirectNav = <Redirect to='/runList'/>
        }
        ...
        if (localStorage.getItem('cookie') === 'Tester') {
            navbarTag = <SideNav
                ...
                <SideNav.Nav selected={selectedNav}>
                    ...
                    <NavItem eventKey="schedule_run">
                        <NavIcon>
                            <i className="fa fa-fw fa-robot" style={{ fontSize: '1.75em' }} />
                        </NavIcon>
                        <NavText>
                            Schedule TestRun
                        </NavText>
