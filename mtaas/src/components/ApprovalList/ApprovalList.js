...
class ApprovalList extends React.Component {
  constructor(props) {
    ...
    //axios.post(hostedAddress + "/getPendingList", data).then(response => {
  ...
  viewTester = email => {
    ...
    //axios.post(hostedAddress + "/getProfile", data).then(response => {
  ...
  approveHandler = arr => {
    ...
    //axios.post(hostedAddress + "/approveTester", data).then(response => {
  ...
  rejectHandler = arr => {
    ...
    //axios.post(hostedAddress + "/rejectTester", data).then(response => {
