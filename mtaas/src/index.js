...
import CreateRun from './components/Runner/CreateRun'
import RunTracker from './components/Runner/RunTracker'
import JobTracker from './components/Runner/JobTracker'
import SuiteTracker from './components/Runner/SuiteTracker'
import TestTracker from './components/Runner/TestTracker'
import ArtifactTracker from './components/Runner/ArtifactTracker'
  ...
  render() {
    return (
      <Router>
        ...
        <Route path = '/scheduleRun' exact component = {CreateRun} />
        <Route path='/runList' exact component={RunTracker} />>
        <Route path='/jobTracker/:id' exact component={JobTracker}/>
        <Route path='/suiteTracker/:rid/:jid/:runname' exact component={SuiteTracker}/>
        <Route path='/testTracker/:rid/:jid/:sid/:runname' exact component={TestTracker}/>
        <Route path='/artifactTracker/:rid/:jid/:sid/:tid/:runname' exact component={ArtifactTracker} />
      </Router>
    );
  }
}
